...
/**
 * This is the item provider adapter for a {@link imaModel2.Arc} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Arc_couleur_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Arc_couleur_feature", "_UI_Arc_type"),
				 ImaModel2Package.Literals.ARC__COULEUR,
				 true,
				 false,
				 false,
	...
	protected void addNextPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Arc_next_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Arc_next_feature", "_UI_Arc_type"),
				 ImaModel2Package.Literals.ARC__NEXT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Arc_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Arc_id_feature", "_UI_Arc_type"),
				 ImaModel2Package.Literals.ARC__ID,
				 true,
				 false,
				 false,
